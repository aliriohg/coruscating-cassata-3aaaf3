  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        {integrantes.map((integrante, i) => (
          ...
          >
            <div className="flex flex-col sm:flex-row">
              {/* Avatar placeholder */}
              <div className="sm:w-40 h-40 sm:h-auto bg-gradient-to-br from-violet-400 to-indigo-500 flex items-center justify-center text-white font-bold text-4xl flex-shrink-0">
      ...
      <div className="mt-10 bg-violet-50 border border-violet-200 rounded-xl p-5 text-sm text-violet-800">
        <strong>¿Cómo editar esta sección?</strong> Modifica los archivos dentro de <code className="bg-violet-100 px-1 rounded">content/integrantes/</code>. Puedes agregar nuevas integrantes creando un nuevo archivo <code className="bg-violet-100 px-1 rounded">.md</code> con el mismo formato.
      </div>
    </div>
  )
}
